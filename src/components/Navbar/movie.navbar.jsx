...
import { BiChevronLeft, BiShareAlt, BiSearch, BiChevronDown, BiMenu } from "react-icons/bi"
    ...
    return (
        <div className='container mx-auto px-4 py-2 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-4'>
                <span className='text-gray-300 text-sm font-normal flex items-center gap-1 hover:text-white cursor-pointer'>Kochi <BiChevronDown /> </span>
